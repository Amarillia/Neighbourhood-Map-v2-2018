...
//CREATE AN ARRAY OF MARKERS
      // These are nearby places that will be shown to the user.
      ...
      function makeMarkerIcon(markerColor) {
        ...
        for (var i = 0; i < locations.length; i++) {
          ...
          markers.push(marker);
          //Change the color of the markers on hover the mouse
...
//ALLOW THE USER TO DISPLAY AND HIDE ALL THE MARKERS ON THE MAP
